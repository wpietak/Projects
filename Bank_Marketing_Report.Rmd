...
The aim of this report is to analyze the following data set: https://archive.ics.uci.edu/ml/datasets/Bank+Marketing# with respect to dependencies between clients' characteristics, economic environment, and a fact of subscribing a term deposit by this client. In order to perform this exercise we will develop 3 classification models with a binary target variable stating whether a given client has subscribed a term deposit or not, evaluate their quality and provide analyses concerning impact of particular variables on target variable. Insight gained from this task conclusions may help
